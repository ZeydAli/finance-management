...
@section('container')
  <form action="/dashboard/transactions" method="post">
    @csrf
    <div>
      <div class="relative mb-3 md:w-8/12 lg:w-6/12 xl:w-4/12" data-te-inline="true" data-te-datepicker-init data-te-input-wrapper-init>
      ...
      <div class="mt-2 md:w-8/12 lg:w-6/12 xl:w-4/12">
      ...
      <div class="my-2 md:w-8/12 lg:w-6/12 xl:w-4/12">
      ...
      <div class="flex gap-4 justify-between mt-4 md:w-8/12 lg:w-6/12 xl:w-4/12">
